...
Lesson: User manuals by the author represent the teaching of a  module of a postgraduate course on "Educational Indicators", 
of statistical analysis of spatial data, through the use of the  statistical language R and the geographic information software QGis.
...
In the same way, it is recommended to review the contents of the manual attached to the documents, in order to become familiar 
with the different actions that can be carried out, through the elements of system management.
